...
function createYouTubeThumbnail(videoId) {
    ...
    thumbnailElement.innerHTML = `
        <a href="https://www.youtube.com/watch?v=${videoId}" target="_blank" rel="noopener noreferrer">
            <img src="${thumbnailUrl}" alt="YouTube Video Thumbnail" class="w-full h-auto rounded">
...
function createEventElement(event) {
    ...
    const videoId = getYouTubeVideoId(event.title);
    if (videoId) {
        contentHtml += createYouTubeThumbnail(videoId).outerHTML;
    }
